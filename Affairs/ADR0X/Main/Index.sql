...
from
    ...
    join SGBSTDN SGBSTDN on SGBSTDN.SGBSTDN_PIDM = SPRIDEN.SPRIDEN_PIDM
         ...
         and SGBSTDN.SGBSTDN_LEVL_CODE = :parm_class_level_select.STVLEVL_CODE

    left outer join SPRADDR SPRADDR on SPRADDR.SPRADDR_PIDM = SPRIDEN.SPRIDEN_PIDM
        and SPRADDR.SPRADDR_ATYP_CODE in (:parm_address_type_select.ATYP_CODE)
        ...
        and SPRADDR.SPRADDR_VERSION = (
             ...
             and SPRADDR1.SPRADDR_ATYP_CODE in (:parm_address_type_select.ATYP_CODE)
