...
from 
    ...
    left outer join SHRLGPA SHRLGPA on SHRLGPA.SHRLGPA_PIDM = SPRIDEN.SPRIDEN_PIDM
     ...
     join SSBSECT SSBSECT on SSBSECT.SSBSECT_CRN = SFRSTCR_CRN              
...
order by
    STVCLAS.STVCLAS_SURROGATE_ID, SPRIDEN.SPRIDEN_SEARCH_LAST_NAME, SSBSECT.SSBSECT_SICAS_CAMP_COURSE_ID
